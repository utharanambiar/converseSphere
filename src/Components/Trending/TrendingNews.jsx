    ...
    <>
      <div className="py-5 ml-3 mr-3">
        <section className="my-5">
          <h1 className="text-xl font-bold">{t("GET_VERIFIED")}</h1>
          <h1 className="font-bold my-2">{t("SUBSCRIBE")}</h1>
        ...
        <section className="mt-7 space-y-5">
          <h1 className="font-bold text-xl py-1">{t("WHATS_TRENDING")}</h1>
          <div>
            <p className="text-sm">
            ...
            <p className="font-bold">{t("TRENDING_NEWS")}</p>
          </div>
